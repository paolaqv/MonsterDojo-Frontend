...
<style  src="@/assets/css/inicio.css"></style>
  ...
  <div class="home-page">
    <header>
      <div class="navbar">
        ...
        <div class="navbar-right" :class="{ active: menuOpen }">
          ...
          <a href="#about" @click="closeMenu">Sobre nosotros</a>
          <a href="#menu" @click="closeMenu">Menú</a>
          <a href="#order" @click="closeMenu">Ubicación</a>
    ...
    <div id="order">
      ...
      <div class="social-icons">
        <a href="https://www.instagram.com/monster.dojo?fbclid=IwZXh0bgNhZW0CMTAAAR1WPIU3x90NBQ40AVuFg6nRMv3uV0D2tRU3_kk1DceRJQy2dNcvhWafPXk_aem_AfHvXe3uWEi0-WSkTUzAsET7HigHsubTugnFw8qfkt-5ryGH0I_tZHC0oK_-g85S9rMbhbA4jvjqi2PSFT2Amjb-" target="_blank">
